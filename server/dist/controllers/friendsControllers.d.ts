...
export declare function acceptRequest(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
export declare function declineRequest(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
export declare function listFriends(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
